...
<body class="p-5">
	<%
		...
		String upNumber = "";  // Khai báo bên ngoài để có thể nhận dữ liêu 
		String upStatus = "";
		String upType = "1";
    ...
    <div class="container" style="max-width: 650px;">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="manager.jsp" class="btn btn-outline-secondary btn-sm rounded-pill px-3">
        ...
        <div class="card card-custom p-4 bg-white">
            ...
            <script>
       			 // 1. Tạo một cuốn từ điển chứa thông tin 3 loại phòng của bạn
       			 const dataLoaiPhong = {
        		 ...
        		 // 2. Hàm thay đổi giao diện khi chọn
       			 function doiLoaiPhong() {
          		 // Lấy ID loại phòng đang được chọn (1, 2, hoặc 3)
            	 let maLoai = document.getElementById("selectLoaiPhong").value;
           
           	     // Tra cứu từ điển để lấy ra sức chứa và giá tương ứng
                 ...
                 // Điền vào ô Giá (Có format thêm dấu phẩy cho đẹp: 1,600,000)
             	 document.getElementById("oGia").value = new Intl.NumberFormat('vi-VN').format(thongTin.gia);
           		 }
      		  }	

       			 // 3. Gọi hàm này một lần ngay khi vừa load trang để nó điền số của loại phòng cũ
